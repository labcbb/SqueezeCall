...
# from basenet.utils.class_utils import basenet_NORM_CLASSES
...
class DecoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.norm1 = torch.nn.LayerNorm(size, eps=norm_eps)
        self.norm2 = torch.nn.LayerNorm(size, eps=norm_eps)
        self.norm3 = torch.nn.LayerNorm(size, eps=norm_eps)
