...
from squeeze_call.embedding import PositionalEncoding
from squeeze_call.utils.common import mask_to_bias
from squeeze_call.utils.mask import (subsequent_mask, make_pad_mask)
...
class TransformerDecoder(torch.nn.Module):
    ...
    def __init__(
        ...
        self.after_norm = torch.nn.LayerNorm(attention_dim, eps=norm_eps)
